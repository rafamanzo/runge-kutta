#default C++ version
c: main3d.o rk_c.o input3d.o vector_operations_c.o vector_field.o output.o
	g++ main3d.o input3d.o rk_c.o vector_operations_c.o vector_field.o output.o -Wall -ansi -o rk
