...
extern void rk2_caller(double *x0, double *y0, int n, double h, fof *dydx, double *y1){
  double k1, k2;
  int i;
...
extern void rk4_caller(double *x0, double *y0, int n, double h, fof *dydx, double *y1){
  double k1,k2,k3,k4;
  int i;
